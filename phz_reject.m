...
%   PHZ = PHZ_REJECT(PHZ,threshold,rejtype)
% 
% INPUT   
...
%   PHZ.proc.reject.locs        = Indices of rejected trials.
%   PHZ.proc.reject.data_locs   = Indices of retained trials.
% 
% EXAMPLES
%   PHZ = phz_reject(PHZ,20)     >> Reject all trials with a value > 20.
% 
%   PHZ = phz_reject(PHZ,3,'sd') >> Reject trials with a value > 3 standard
