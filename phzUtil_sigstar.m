%PHZUTIL_SIGSTAR  Add asterisks to bar plots. This function is
%   taken from https://github.com/raacampbell/sigstar. It has
%   been slightly modified (i.e., to allow for marginal 
%   significance and control font size), and renamed to fit
%   with the conventions of this toolbox. Below is the 
%   original documentation for this function:
%
...
function varargout=phzUtil_sigstar(groups,stats,nosort,fontsize)

    % default fontsize (added by Gabriel A. Nespoli 2016-06-28)
